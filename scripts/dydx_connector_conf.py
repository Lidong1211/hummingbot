...
def main():
    if len(sys.argv) < 5:
        print("用法: python scripts/dydx_connector_conf.py <目标输出目录> <密码> <助记词/私钥> <dydx地址>")
        print("示例: python scripts/dydx_connector_conf.py conf_taker Aa123456 'mnemonic phrase...' 'dydx1...'")
        sys.exit(1)
